...
class GetHistoricCybersourceTransactions extends Command
{
    protected $signature = 'reporting:cybersource-historic';
    protected $description = 'Sync historic transactions from Cybersource to local database';
    ...
    public function handle()
    {
        ...
        $this->info('Starting Historic Cybersource transaction sync...');
        ...
        foreach ($merchants as $merchant) {
            ...
            try {
                $this->info("\nProcessing historic transactions for merchant: " . $merchant['merchant']);
                ...
                do {
                    $requestObjArr = [
                        ...
                        "query" => "submitTimeUtc:[NOW/DAY-30DAYS TO NOW/DAY+1DAY}",
                        "offset" => $offset,
                        "limit" => $limit,
...
//                                    $this->info("Transaction already exists: " . $transactionData['txn_id']);
                ...
                Log::error("Cybersource Historic Transaction Sync Error for merchant {$merchant['merchant']}: " . $e->getMessage());
            }
        }

        $this->output->progressFinish();
        $this->info("\nHistoric transaction sync completed");
    }
}
