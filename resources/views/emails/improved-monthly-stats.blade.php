...
@endphp
Greetings,<br/>
<p>Please find below the monthly transaction report for {{ $report_date }}.</p>
<p>Note: The transactions captured occurred during the specified month period.</p>

<h4 style="color: #333;">Monthly Transaction Summary</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
            ...
            <th style='padding: 10px;'>Value (This Month)</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr style='background-color: #2D1F3F; color: #fff'>
            <td style='padding: 10px;' align='left' colspan="2"><b>TOTAL VALUE THIS MONTH</b></td>
            <td style='padding: 10px;' align='right'><b>{{ number_format($cumulative_stats['daily']['totals']->successful_amount, 2) }}</b></td>
        </tr>
    </tbody>
</TABLE>

<h4 style="color: #333;">Monthly Settlement Summary</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
            <th style='padding: 10px;'>Platform</th>
...
<h4 style="color: #333;">Monthly Settlement Charges</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
            <th style='padding: 10px;'>Platform</th>
...
<h4 style="color: #333;">Monthly Currency Distribution</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
            <th style='padding: 10px;'>Currency</th>
...
<h4 style="color: #333;">Monthly Platform Performance</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
...
<h4 style="color: #333;">Monthly Merchant Activity</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
...
<h4 style="color: #333;">Monthly Card Usage Analysis</h4>
<TABLE cellspacing='0' border=1 cellpadding='5' style='border-collapse: collapse; width: 100%;'>
    <thead style='background-color: #2D1F3F; color: #fff'>
        <tr>
            <th style='padding: 10px;'>Platform</th>
