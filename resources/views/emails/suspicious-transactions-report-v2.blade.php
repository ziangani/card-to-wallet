...
<body>
    <div class="container">
        ...
        <div class="warning">
            This report contains potentially suspicious transaction activities that require review. Detailed transaction data is attached in CSV files.
        </div>
        ...
        <div style="margin-top: 30px; font-size: 12px; color: #6c757d;">
            <p>This is an automated security report. Please review the attached CSV files for detailed transaction data.</p>
