                            ...
                            <div class="card shadow ">
                                ...
                                <form id="getBill" method="get" class="form" action="{{url("frm/{$app->id}/bills")}}">
                                    <div class="card-body">
                                        ...
                                        <div class="p-3 pt-0">
                                            <h5 class="p-3 pt-0">Populate the form below to complete payment.</h5>
                                            ...
                                            <div class="amount_wrapper" style="display: none">
                                                <div class="mb-3">
                                                    @if($amount_field->type == 'number')

                                                        <div class="mb-4">
                                                            <label class="form-label"
                                                                   for="amount_field">{{$amount_field->label}}</label>
                                                            <div class="input-group">
                                                                @if($amount_field->prefix)
                                                                    <span
                                                                        class="input-group-text">{{$amount_field->prefix}}</span>
                                                                @endif
                                                                <input type="{{$amount_field->type}}"
                                                                       class="form-control"
                                                                       name="{{$amount_field->name}}"
                                                                       placeholder="{{$amount_field->placeholder}}"
                                                                       id="amount_field" {{($amount_field->required ? 'required' : '')}}/>
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
    ...
    <script type="application/javascript">
        ...
        jQuery(document).ready(function ($) {
            ...
            $('#amount_field').on('change', function () {
                ...
                var selected_amount = parseFloat($("#amount_field").val());
                ...
                item_id = my_item_id;
                balance = (selected_amount * 1);
                item_amount = (selected_amount * 1);
